...
export async function updateGameFetch(
  gameId: string,
  userId: string,
...
export async function createCardFetch(
  userId: string,
  card: any,
  markType: string
) {
...
export async function updateCardFetch(
  userId: string,
  card: any,
  markType: string,
  id: string
