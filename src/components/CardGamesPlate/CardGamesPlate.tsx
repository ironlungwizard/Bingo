...
const CardGamesPlate = ({
    ...
    const { infoOn, infoOff, showSingUp, showLogIn, hide } = bindActionCreators(
        actionCreators,
        dispatch
    );
    ...
    useMemo(() => {
        getCard(id).then((Response: XMLHttpRequest["response"]) => {
            if (Response) {
                ...
                navigate(`..`);
                infoOn(
                    "Card not found! It may be deleted or URL is not right.",
                    "error"
                );
            }
        });
    ...
    useMemo(() => {
        getMyGamesByCard(id, auth["id"]).then(
            (Response: XMLHttpRequest["response"]) => {
    ...
    return (
        <Card
            key={index}
            sx={{
                width: { xs: "360px", sm: "620px", lg: "1000px" },
        ...
        >
                    ...
                    <div>
                        <Button
                            ...
                            sx={{
                                marginTop: 1,
                                marginLeft: 1,
                                paddingLeft: { xs: "5px", lg: "15px" },
                                paddingRight: { xs: "5px", lg: "15px" },
                                minWidth: { xs: "30px", lg: "64px" },
                            }}
                        >
                            <PreviewIcon
                                fontSize="large"
            ...
            <Collapse in={expanded} timeout="auto" unmountOnExit>
                <CardContent sx={{ paddingTop: 0 }}>{games}</CardContent>
            </Collapse>
        </Card>
    );
};
